 ...
 * 
 */
@WebFault(name = "ClassNotFoundException", targetNamespace = "http://microServices.MSBenchmark/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: msbenchmark.microservices.ClassNotFoundException
     */
